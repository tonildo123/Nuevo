...
public class DBTuOficinaDeEmpleo extends SQLiteOpenHelper {
    ...
    private String sqlCreateOfertaLaboral     = "CREATE TABLE guiamipyme_syme(_id INTEGER PRIMARY KEY,puesto TEXT, localidad TEXT,urlimagen, requisitos TEXT,modificacion TEXT)";
    private String sqlCreateCursoCapacitacion = "CREATE TABLE guiamipyme_syme(_id INTEGER PRIMARY KEY,tematica TEXT,urlimagen TEXT, modificacion TEXT)";
